[# Masa SDK
 - v3.13.0-alpha.3](README.md) / Exports
...
Ƭ **NetworkName**: ``"goerli"`` \| ``"ethereum"`` \| ``"alfajores"`` \| ``"celo"`` \| ``"mumbai"`` \| ``"polygon"`` \| ``"bsctest"`` \| ``"bsc"`` \| ``"opbnbtest"`` \| ``"opbnb"`` \| ``"basegoerli"`` \| ``"base"`` \| ``"scrollsepolia"`` \| ``"scroll"`` \| ``"unknown"``
