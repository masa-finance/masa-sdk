[# Masa SDK
 - v3.0.4](../README.md) / [Exports](../modules.md) / ERC20Interface
...
| Name | Type |
| :------ | :------ |
| `nameOrSignatureOrTopic` | ``"symbol"`` \| ``"balanceOf"`` \| ``"name"`` \| ``"totalSupply"`` \| ``"decimals"`` \| ``"allowance"`` \| ``"approve"`` \| ``"decreaseAllowance"`` \| ``"increaseAllowance"`` \| ``"transfer"`` \| ``"transferFrom"`` |
